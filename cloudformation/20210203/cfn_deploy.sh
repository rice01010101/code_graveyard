...
CNF_STACK_NAME=ProdMyBlog

# s3にアップロードしテンプレートパスを変換する
aws cloudformation package --template-file ${CNF_PACKAGE_TEMPLATE} --s3-bucket cloudformation4myblog-riceincom --output-template-file ${CNF_TEMPLATE}
